...
foreach ( $urls as $i => $url )
{
    ...
    $results[$i]['value_change'] = $results[$i]['value_change'] >= 0 ? '+'.number_format($results[$i]['value_change']) : number_format($results[$i]['value_change']);
    $results[$i]['value_change'] = $results[$i]['value_change'];
